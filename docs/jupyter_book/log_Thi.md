...
**Mình đã học được gì:** Cách quản lý project tổng thể, cách thu thập và duyệt file tự động bằng Python.
**Khó khăn và giải pháp:** Khó khăn trong việc đồng bộ thư mục code giữa các thành viên. Giải pháp là chuẩn hóa lại cấu trúc thư mục (src, docs, infra) và sửa lại đường dẫn đồng loạt.
