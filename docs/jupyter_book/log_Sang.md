...
## 🧠 Reflection (Đánh giá lại)
**Mình đã học được gì:** Nắm vững cấu trúc AST của Python và cách băm nhỏ source code thành Code Property Graph (CPG). Hiểu được sức mạnh của việc thiết kế hệ thống Event-Driven.
**Khó khăn và giải pháp:** Khó khăn khi đảm bảo tốc độ parse trên số lượng file lớn (hàng nghìn file). Giải pháp là áp dụng Incremental Cache để chỉ parse những file bị thay đổi, giúp tiết kiệm thời gian đáng kể.
